...
withDefaults(
  ...
  { showBack: false, showNotification: false, showLogo: false, transparent: false },
)
    ...
    <div class="mx-auto max-w-lg lg:max-w-2xl">
      <div class="flex h-14 items-center justify-between px-4">
        ...
        <div class="flex items-center justify-end gap-1">
          ...
          <BaseButton v-if="user" variant="ghost" size="icon" class="rounded-full" @click="handleLogout">
